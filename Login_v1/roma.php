<div style=" height: 0px; text-align: center; margin: 80px">
          ...
          <h1><i class="chess rook icon"></i>Conversor de Números Romanos</h1>
...
<div style="text-align: center;">
    <button class="fluid ui green button" type="submit" name="calc" value="Calcular">
